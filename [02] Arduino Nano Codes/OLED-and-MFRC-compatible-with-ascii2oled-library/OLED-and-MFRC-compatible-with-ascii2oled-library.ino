//Last modified: 26-Jan-24
//This is the stable version of the periphery microcontroller code, 
//But stopped working when the SSD1306Ascii OLED functionalities were
//introduced. Remove those it'll work as expected. 
